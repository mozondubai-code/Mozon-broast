...
description: "Tool prompt for calling the claude.ai RemoteTrigger API to list, get, create, update, or run remote routines and create webhook triggers for them"
ccVersion: "2.1.225"
-->
