/* LEGACY — React/Next drop-in, single-motion frame scrub only.
   Feature parity with video-scroll-effect.js was NOT maintained: no `beats`,
   no `loopBack`, no `bgFrom`/`bgTo` background interpolation, no
   `[data-live-count]` meter. Use the vanilla engine for anything using those.
   Kept for projects that already embed this in an existing React app. */
"use client";
 ...
 *     lines={[
 *       { text: "MADE TO MOVE.",   in: 0.0,  out: 0.30 },
 *       { text: "BUILT ON SCROLL.", in: 0.34, out: 0.64 },
 *       { text: "SEE IT UNFOLD.",  in: 0.70, out: 1.0  },
 *     ]}
 *   />
 *
